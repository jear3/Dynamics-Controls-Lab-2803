...
Section15_TransitionRadius = zeros(1,26);
...
Section15_TransitionArcLength = linspace(1,26);

Section15_TransitionAngle = zeros(1,26);
...
Section15_FinalHeight = 81.2; %m

% Flat section
Section17_ArclengthPlot = linspace(39.4,100);
...
Section25_TransitionRadius = linspace(1,26); % m
...
Section25_TransitionAngle = linspace(1,26);
...
Section45_TransitionRadius = linspace(1,26);

for s = size(Section25_TransitionRadius)
    Section25_TransitionRadius = (1/2) * (1 + (4 * s^2))^(3/2);
end

Section45_ArclengthPlot = linspace(775.16,800.16);
Section45_Arclength = linspace(0,25);

Section45_TransitionAngle = linspace(1,26);

for s = size(Section25_TransitionAngle)
    Section25_TransitionAngle(s) = log((1 + (4 * s^2))^(3/2));
end
...
% Flat
% Section55_Gforce = 1;
% Section55_Velocity = SectionXX_Velocity;
